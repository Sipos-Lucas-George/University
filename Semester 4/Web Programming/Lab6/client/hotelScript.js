    ...
    function showTable() {
        $.ajax({
            ...
            success: function (result) {
                ...
                const header = "<thead><th>ID</th><th>Name</th><th>Location</th></thead>";
                datatable.append(header);

                result.forEach(function (item) {
                    const row = "<tr class=\"table_row\"><td>" + item.id + "</td><td>" + item.name + "</td><td>" + item.location + "</td></tr>";
                ...
                rows.forEach(function (item) {
                    item.addEventListener("click", function () {
                        ...
                        document.getElementById("location-input").value = item.getElementsByTagName("td")[2].innerHTML;
                    });
                });
            },
            error: function () {
