...
public:
    ...
    void setupUi(QWidget *GUI)
    {
        ...
        //extras
        QLinearGradient colorGradient = QLinearGradient(0, 0, 1000, 1000);
        colorGradient.setSpread(QGradient::RepeatSpread);
        colorGradient.setColorAt(0, QColor(0,255,255));
        colorGradient.setColorAt(1, QColor(0,128,255,255));
        QBrush colorBrush = QBrush(colorGradient);

        QPalette qPalette;
        qPalette.setBrush(QPalette::Base, colorBrush);
        this->watchListWidget->setPalette(qPalette);
