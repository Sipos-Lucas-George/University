...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ProgrammerWindow_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_ProgrammerWindow_t qt_meta_stringdata_ProgrammerWindow = {
    {
QT_MOC_LITERAL(0, 16) // "ProgrammerWindow"
...
const QMetaObject ProgrammerWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ProgrammerWindow.offsetsAndSize,
    qt_meta_data_ProgrammerWindow,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ProgrammerWindow_t
