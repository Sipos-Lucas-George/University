...
public class ExampleView implements View{
    ...
    protected static IStatement example88() {
        return buildExample(
                new DeclarationStatement("a", new IntType()),
                new DeclarationStatement("b", new IntType()),
    ...
    protected static IStatement example99() {
        return buildExample(
    ...
    public static IStatement[] exampleList(){
        return new IStatement[]{example0(), example1(), example2(), example3(), example4(), example5(), example6(), example7(), example88(), example99()};
    }
    ...
    public void execute(){
        ...
        try {
            Repository repository = new Repository(programStates, "D:\\University\\UNI\\Java\\Final\\src\\main\\java\\Repository\\logFile.txt");
