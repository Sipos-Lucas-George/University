...
public class ProgramController {
    ...
    @FXML
    private TableColumn<Pair<Integer, Integer>, String> LatchCol1;

    @FXML
    private TableColumn<Pair<Integer, Integer>, String> LatchCol2;
    ...
    public void initialize() {
        ...
        LatchCol1.setCellValueFactory(p -> new SimpleStringProperty(p.getValue().first.toString()));
        LatchCol2.setCellValueFactory(p -> new SimpleStringProperty(p.getValue().second.toString()));
    ...
    private void populateLatch() {
        ILatch latch;
        if(!controller.getProgramState().isEmpty())
            latch = controller.getProgramState().get(0).getLatch();
        else
            latch = new MyLatch();
