...
public class ProgramState {
    ...
    public ProgramState(IStack<IStatement> execStack, IDictionary<String, Value> symTable, IList<String> out, IDictionary<String, BufferedReader> fileTable, IHeap heap, ILatch latchTable) {
