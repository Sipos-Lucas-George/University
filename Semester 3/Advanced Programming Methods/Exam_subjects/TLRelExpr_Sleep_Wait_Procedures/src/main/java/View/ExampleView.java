...
public class ExampleView implements View{
    ...
    protected static IStatement example9(){
        return buildExample(
                ...
                new Wait(new ValueExpression(new IntValue(10))),
                new PrintStatement(
                        new ArithExpression(
    ...
    protected static IStatement example10(){
        return buildExample(
                ...
                new Sleep(new ValueExpression(new IntValue(10))),
                new PrintStatement(
                        new ArithExpression(
                                BinaryExpression.OPERATOR.MULT,
                                new VariableExpression("v"),
    ...
    protected static IStatement example11(){
        return buildExample(
                new Procedure(
                        "sum",
                        Arrays.asList("a", "b"),
    ...
    public static IStatement[] exampleList(){
        return new IStatement[]{example0(), example1(), example2(), example3(), example4(), example5(), example6(), example7(), example8(), example9(), example10(), example11()};
    }
